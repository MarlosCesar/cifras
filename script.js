...
function renderTabs() {
  ...
  tabsList.innerHTML = '';
  DEFAULT_TABS.forEach(tab => tabsList.appendChild(createTabElement(tab)));
  appState.userTabs.forEach(tab => tabsList.appendChild(createTabElement(tab, true)));
...
// ================ FULLSCREEN API: CIFRA COBRE TELA INTEIRA ================
function openFullscreenView(imageSrc, imageName) {
  ...
  function closeFullscreen() {
    // Sai do fullscreen nativo se necessário
